...
OBJ1_RECT_COORDS = (33, 80, 50, 95)
OBJ1_COLOR = (0, 0, 255)  # BGR Red
OBJ1_TEXT_COORDS = (30, 110)  # Text below the object

# Object 2: A Red Cone
OBJ2_LABEL = "Cone"
# (Center X, Center Y, Radius)
OBJ2_CIRCLE_COORDS = (44, 50, 13)
OBJ2_COLOR = (255, 0, 0)  # BGR Blue
OBJ2_TEXT_COORDS = (30, 35)  # Text above the object
...
cv2.rectangle(img, (x1, y1), (x2, y2), OBJ1_COLOR, 1)
cv2.putText(
    img,
    OBJ1_LABEL,
    OBJ1_TEXT_COORDS,
...
cv2.circle(img, (center_x, center_y), radius, OBJ2_COLOR, 1)
cv2.putText(
    img,
    OBJ2_LABEL,
    OBJ2_TEXT_COORDS,
